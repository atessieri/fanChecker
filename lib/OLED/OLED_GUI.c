...
UBYTE FAN_MODE  ;
void POE_HAT_Display(char *hostname, UWORD TEMP, UBYTE FAN_TEMP)
{
    UBYTE t[10];
    GUI_Clear();
    GUI_DisString_EN(0 , 0, "Host:", &Font12, FONT_BACKGROUND, WHITE);
    GUI_DisString_EN(38 , 0, hostname, &Font12, FONT_BACKGROUND, WHITE);
